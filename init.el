...
(custom-set-variables
 ...
 '(package-selected-packages
   '(magit counsel-projectile projectile general doom-themes which-key use-package rainbow-delimiters ivy-rich helpful doom-modeline counsel command-log-mode)))
(custom-set-faces
